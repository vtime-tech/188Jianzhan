...
INSERT INTO `kaxiao_config` VALUES ('addgg','<div class=\"panel-body\">\r\n<font color=\"#000000\"> <div class=\"list-group-item reed\">\r\n<span class=\"label label-default\">支持搭建：</span>\r\n<span class=\"label label-primary\">代刷网</span>  <span class=\"label label-danger\">发卡网</span> <span class=\"label label-warning\">博客网</span> <span class=\"label label-success\">要饭网</span> <span class=\"label label-primary\">表白墙</span>  <span class=\"label label-danger\">音乐网</span> <span class=\"label label-warning\">同学录</span> <span class=\"label label-success\">易支付</span> \r\n</font></div>\r\n<li class=\"list-group-item\">交流群：164483883</li>\r\n</div>'),('alipay','1'),('authcode',''),('defaultpay','alipay'),('description','妖巴巴建站系统®-新一代智能自助建站系统,自动化建设神器。易学易懂,功能强大,拥有多种精美网站款式。无需建站技术，一键自动搭建。价格低，性比价高，节省资金！'),('domain',''),('epayapi',''),('epayid',''),('epaykey',''),('epid',''),('eplock','0'),('epurl',''),('fwqip',''),('fxgg','<div class=\"panel-body\">\r\n<li class=\"list-group-item\">系统版本:188建站系统™/妖巴巴建站系统® v2.10-rc2</li>\r\n<font color=\"#000000\"> <div class=\"list-group-item reed\">\r\n<span class=\"label label-default\">支持搭建：</span>\r\n<span class=\"label label-primary\">代刷网</span>  <span class=\"label label-danger\">发卡网</span> <span class=\"label label-warning\">博客网</span> <span class=\"label label-success\">要饭网</span> <span class=\"label label-primary\">表白墙</span>  <span class=\"label label-danger\">音乐网</span> <span class=\"label label-warning\">同学录</span> <span class=\"label label-success\">易支付</span> \r\n</font></div>\r\n<li class=\"list-group-item\">交流群：164483883</li>\r\n<li class=\"list-group-item\">外包禁止随意划拨配额，出售多少钱就划拨多少个配额</li>\r\n<li class=\"list-group-item\">如需绑定自己的域名请先把域名解析到iP：127.0.0.1 然后再去主站列表里面绑定域名</li>\r\n</div>'),('fxpe','0.00'),('icp','京ICP证88888号'),('keywords','188建站系统,一键建站系统,自助建站,智能建站,建站系统,一键搭建,188建站系统,玩客建站,妖巴巴建站系统,辽宁微时光科技有限公司'),('kfqq','954800800'),('optdomain',''),('player','0'),('qqpay','1'),('template','1'),('title','188建站系统/妖巴巴建站系统'),('titles','您值得信赖的云建站专家'),('voice','尊敬的{per}，您好，欢迎使用\"{title}\"，您目前还有\"{peie}\"个配额，可以在站点管理中搭建网站。'),('wbpe','0.00'),('wxpay','1'),('xlchkey','pK0xsYXLVy');
